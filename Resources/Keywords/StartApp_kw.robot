...
Check popup and accept 1 only use now
    ...
    ${passed}  Run Keyword And Return Status     Wait Until Element is visible   id=com.android.permissioncontroller:id/grant_dialog        30s  
    IF  ${passed}
            ...
            Wait Until Element is visible       id=com.android.permissioncontroller:id/permission_message                   30s
